...
#define AUDIO_HARDWARE_MODULE_ID_BTMIC "btmic"
...
/* BTMIC Input source selection */
#define AUDIO_PARAMETER_KEY_BTMIC_SOURCE    "bt_mic_source"
#define AUDIO_PARAMETER_VALUE_BTMIC_HID     "hid"
#define AUDIO_PARAMETER_VALUE_BTMIC_HEADSET "headset"
