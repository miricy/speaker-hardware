...
protected:
        ...
        static const VolumeCurvePoint sDefaultSystemSpeakerTouch[AudioPolicyManagerBase::VOLCNT];
        ...
        audio_io_handle_t mInputRouter;
        ...
        bool mHasBTMic; // true on platforms with support for BT Mic audio
