...
enum audio_source {
    ...
    AUDIO_SOURCE_BT_MIC = 9, // Match the ENUM value in audio_source_t (system/audio.h)
    AUDIO_SOURCE_FM = 12,
...
public:
    ...
    enum audio_devices {
        ...
        DEVICE_IN_BLUETOOTH_MIC = 0x1000000,
        DEVICE_IN_AF = 0x2000000,
        DEVICE_IN_FM = 0x4000000,
        DEVICE_IN_DEFAULT = 0x80000000,

        DEVICE_IN_ALL = (DEVICE_IN_COMMUNICATION | DEVICE_IN_AMBIENT | DEVICE_IN_BUILTIN_MIC |
                DEVICE_IN_BLUETOOTH_SCO_HEADSET | DEVICE_IN_WIRED_HEADSET | DEVICE_IN_AUX_DIGITAL |
                DEVICE_IN_VOICE_CALL | DEVICE_IN_BACK_MIC | DEVICE_IN_FM | DEVICE_IN_BLUETOOTH_MIC | DEVICE_IN_DEFAULT)
    };
